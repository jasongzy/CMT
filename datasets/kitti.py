...
class kittiDataset(base_dataset.BaseDataset):
    ...
    def _build_tracklet_anno(self):
        ...
        for scene in self.scene_list:
            ...
            if self.category_name in ["Car", "Van", "Truck", "Pedestrian", "Person_sitting", "Cyclist", "Tram", "Misc"]:
    ...
    def _get_frame_from_anno(self, anno):
        ...
        if self.coordinate_mode == "velodyne":
            ...
            orientation = Quaternion(axis=[0, 0, -1], radians=anno["rotation_y"]) * Quaternion(
        ...
        try:
            try:
                ...
                # VELODYNE PointCloud
                velodyne_path = os.path.join(self.KITTI_velo, scene_id, "{:06}.bin".format(frame_id))
